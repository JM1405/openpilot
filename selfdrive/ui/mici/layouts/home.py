...
class MiciHomeLayout(Widget):
  def __init__(self):
    ...
    self._openpilot_label = UnifiedLabel(brand_text("sunnypilot"), font_size=76 if koranipilot_enabled() else 96, font_weight=FontWeight.DISPLAY, max_width=480, wrap_text=False)
